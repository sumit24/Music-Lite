...
namespace UnityStandardAssets.Water
{
 ...
 float[] samples; // audio samples
		...
		void Start (){
			qSamples = (int)GetComponent<AudioSource>().clip.length;
